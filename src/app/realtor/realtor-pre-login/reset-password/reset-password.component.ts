...
export class ResetPasswordComponent {
  ...
  constructor(
    ...
    const resolvedData = this.actvRoute.snapshot.data['routeData'];
    if (resolvedData?.data) {
      this.pageDetails = resolvedData.data
      this.title.setTitle(this.pageDetails?.title?this.pageDetails?.title:'First Premier Home Warranty:Real Estate Professional Reset Password');
  ...
  onSubmit() {
    ...
    if (this.resetPasswordForm.valid) {
      ...
      this.apiSvc.post(AppConfig.apiUrl.realtorPortal.updatePassword, postData).subscribe({
        next: (response: any) => {
