export const regEx = {
    ...
    card_number_format: /^\[0-9]{4}\s[0-9]{4}\s[0-9]{4}\s[0-9]{4}$/,
    card_name: /^[a-zA-Z\s\-'\.]{4,30}$/,
    card_expiry_date_format: /^(0[1-9]|1[0-2])\/[0-9]{2}$/,
    aba_routing: /^\d{1,9}$/,
    ...
    alpha_with_spaces: /^(\d{10}|\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3}))$/,
